...
Imgbody = pygame.transform.scale(pygame.image.load("C:\\WorkSpace\\PythonGame\\SnakeCovid\\pattern-2813165_960_720.jpg"),(m,m))
Imghead = pygame.transform.scale(pygame.image.load("C:\\WorkSpace\\PythonGame\\SnakeCovid\\unnamed.jpg"),(m,m))
Imgfood = pygame.transform.scale(pygame.image.load('C:\\WorkSpace\\PythonGame\\SnakeCovid\\unnamed (1).jpg'),(m,m))
# tạo cửa sổ
...
def win_game():
    ...
    gsurf = gfont.render('Win Game!!!',True,red)
